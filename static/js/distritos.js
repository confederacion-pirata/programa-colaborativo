...
<p>Los principales problemas identificados por sus habitantes son: la precariedad creciente del transporte público, el incumplimiento del actual Plan de Inversión para el distrito y de la la Agenda 21 Usera, la nefasta y desaprovechada inversión de la Caja Mágica y la finalización de Burjassot Rio.</p>',
    puente_de_vallecas: '',
...
El principal problema del distrito es que tiene una de las más altas tasas de desempleo de la ciudad de Burjassot, lo que genera una situación de grave desigualdad social y un elevado número de población en riesgo de exclusión.</p>',

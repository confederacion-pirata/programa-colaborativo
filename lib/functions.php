...
//Envía mail
	...
	$mensaje   = 'Hola:'. "\r\n" .'Recibes este email porque has solicitado una nueva contraseña en programa.totesamburjassot.net. 
	Si no es así, ponte en contacto con nosotros en este mismo correo'. "\r\n" .'Nueva contraseña: '.$password. "\r\n" . 'Un saludo';
	$cabeceras = 'From: Totes amb Burjassot <contacte@totesamburjassot.net>' . "\r\n" .
    'Reply-To: contacte@totesamburjassot.net' . "\r\n" .
